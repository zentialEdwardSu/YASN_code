    ...
    internal static class GeneralSettingsFieldFactory
    {
        internal static GeneralSettingFields Create()
        {
            SettingField autoStartField = new SettingField
            {
                ...
                BoolValue = global::YASN.App.Desktop.AutoStartManager.IsAutoStartEnabled(),
                ShouldSync = false
            };
            ...
            {
                Key = global::YASN.App.Desktop.FloatingWindowTaskbarVisibility.SettingKey,
                Title = "Show notes in taskbar",
                Description = "控制Note的悬浮窗是否在任务栏显示。",
                FieldType = SettingFieldType.Select,
                Value = global::YASN.App.Desktop.FloatingWindowTaskbarVisibility.DefaultValue,
                ShouldSync = true
            };
            ...
            {
                Label = "始终显示",
                Value = global::YASN.App.Desktop.FloatingWindowTaskbarVisibility.AlwaysShowValue
            });
            floatingTaskbarVisibilityField.Options.Add(new SettingOption
            {
                Label = "始终不显示",
                Value = global::YASN.App.Desktop.FloatingWindowTaskbarVisibility.AlwaysHideValue
            });
            floatingTaskbarVisibilityField.Options.Add(new SettingOption
            {
                Label = "仅 TopMost 不显示",
                Value = global::YASN.App.Desktop.FloatingWindowTaskbarVisibility.HideTopMostOnlyValue
            });

            SettingField previewStyleField = new SettingField
            {
                Key = global::YASN.Infrastructure.PreviewStyleManager.SettingKey,
                Title = "Markdown preview style",
                Description = "Load CSS from data/style and apply it to markdown preview.",
                FieldType = SettingFieldType.Select,
                Value = global::YASN.Infrastructure.PreviewStyleManager.DefaultStyleRelativePath,
                ShouldSync = false
            };
            previewStyleField.Options.Add(new SettingOption
            {
                Label = global::YASN.Infrastructure.PreviewStyleManager.DefaultStyleRelativePath,
                Value = global::YASN.Infrastructure.PreviewStyleManager.DefaultStyleRelativePath
            });

            SettingField dataDirectoryField = new SettingField
            {
                Key = global::YASN.Infrastructure.AppPaths.DataDirectorySettingKey,
                Title = "Data directory",
                Description = "设置 YASN 读取 JSON 数据的目录（例如 notes.index.json）。支持绝对路径或相对程序目录路径，重启后生效。",
                FieldType = SettingFieldType.Text,
                Value = global::YASN.Infrastructure.AppPaths.DataDirectory,
                ShouldSync = false,
