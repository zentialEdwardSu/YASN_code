...
namespace YASN
{
    public static class PreviewStyleManager
    {
        public const string SettingKey = "note.previewStyle";
        public const string DefaultStyleRelativePath = "default.css";
        private static readonly string BundledStyleRoot = Path.Combine(AppPaths.BaseDirectory, "Assets", "style");
        ...
        public static string ResolveStyle(string? configuredStyle)
        {
            EnsureInitialized();
        ...
        public static string BuildStyleHref(string styleRelativePath, long cacheToken)
        {
        ...
        public static string ToStyleAbsolutePath(string styleRelativePath)
        {
            EnsureInitialized();
